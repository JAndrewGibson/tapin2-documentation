# GET v2/venues/{venueId}/events/{eventId}/orders/{orderId}

Retrieve details for the specified endpoint.

- **Endpoint**: `v2/venues/{venueId}/events/{eventId}/orders/{orderId}`
- **Method**: `GET`
...
| `seatId` | Null | Unique identifier for the seat. |
| `seat` | Null |  |
| `hasSeat` | Boolean |  |
| `pagerNumber` | Null |  |
...
| `device` | Object |  |
| `device.title` | String | The name or title of the title. |
| `device.id` | Integer | Unique identifier for the record. |
...
| `location.imageUrl` | String | URL link to the resource. |
| `location.imageUrlMobile` | String | URL link to the resource. |
| `location.imageUrlTerminal` | String | URL link to the resource. |
| `location.imageUrlPreorder` | String | URL link to the resource. |
| `location.imageUrlMenuPortrait` | String | URL link to the resource. |
| `location.imageUrlMenuLandscape` | String | URL link to the resource. |
| `location.orderingEnabled` | Boolean |  |
| `location.isActive` | Boolean | Indicates whether the record is currently active. |
| `location.pauseExpiration` | Null |  |
| `location.isHawker` | Boolean |  |
| `location.orderId` | Integer | Unique identifier for the order. |
| `location.isDelivery` | Boolean |  |
| `location.isPickup` | Boolean |  |
| `location.waitTime` | String | Timestamp in standard formatting. |
| `location.availablePickupTimes` | Null | Timestamp in standard formatting. |
| `location.isPaused` | Boolean |  |
| `location.id` | Integer | Unique identifier for the record. |
| `location.title` | String | The name or title of the title. |
...
```json
{
    ...
    "totalNet": 0.0,
    "note": "",
    "guid": "1d9d9be7-3b48-4b68-9571-d215ebea4ec8",
    "saleDate": null,
    "printDate": null,
    "claimedDate": null,
...
---
[🔗 View Original Documentation](https://api.tapin2.co/Help/Api/GET-v2-venues-venueId-events-eventId-orders-orderId)
