# GET v2/venues/{venueId}/service/{serviceId}/options/{locationId}

Retrieve details for the specified endpoint.

- **Endpoint**: `v2/venues/{venueId}/service/{serviceId}/options/{locationId}`
- **Method**: `GET`
...
---
[🔗 View Original Documentation](https://api.tapin2.co/Help/Api/GET-v2-venues-venueId-service-serviceId-options-locationId)
