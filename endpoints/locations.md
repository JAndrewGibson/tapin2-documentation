# GET v2/locations/{venueId}/{includePreorder}

Retrieve details for the specified endpoint.

- **Endpoint**: `v2/locations/{venueId}/{includePreorder}`
- **Method**: `GET`
...
---
[🔗 View Original Documentation](https://api.tapin2.co/Help/Api/GET-v2-locations-venueId-includePreorder)
