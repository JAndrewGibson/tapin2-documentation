# GET v4/venues/{venueId}/orders/small/modified/{fromDate}/{fromMins}/{toDate}/{toMins}

- **Endpoint**: `v4/venues/{venueId}/orders/small/modified/{fromDate}/{fromMins}/{toDate}/{toMins}?addDayToEndOfRange={addDayToEndOfRange}`
- **Method**: `GET`
...
---
[🔗 View Original Documentation](https://api.tapin2.co/Help/Api/GET-v4-venues-venueId-orders-small-modified-fromDate-fromMins-toDate-toMins)
