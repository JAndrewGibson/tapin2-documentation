# GET {version}/YellowDog

Retrieve details for the specified endpoint.

- **Endpoint**: `{version}/YellowDog`
- **Method**: `GET`
...
| :---| :---| :---| :---|
| `version` | Integer | Path | The parameter in path. |
...
---
[🔗 View Original Documentation](https://api.tapin2.co/Help/Api/GET-version-YellowDog)
