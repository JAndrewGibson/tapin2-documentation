# GET v2/venues/{venueId}/orders/modified/{fromDate}/{toDate}

- **Endpoint**: `v2/venues/{venueId}/orders/modified/{fromDate}/{toDate}`
- **Method**: `GET`
...
---
[🔗 View Original Documentation](https://api.tapin2.co/Help/Api/GET-v2-venues-venueId-orders-modified-fromDate-toDate)
