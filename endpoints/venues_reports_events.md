# GET v2/venues/{venueId}/reports/{reportType}/events/{eventId}

- **Endpoint**: `v2/venues/{venueId}/reports/{reportType}/events/{eventId}`
- **Method**: `GET`
...
---
[🔗 View Original Documentation](https://api.tapin2.co/Help/Api/GET-v2-venues-venueId-reports-reportType-events-eventId)
