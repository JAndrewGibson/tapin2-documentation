# GET v4/venues/{venueId}/locations/{locationId}/products/small/modified/{fromDate}/{fromMins}/{toDate}/{toMins}

Retrieve details for the specified endpoint.

- **Endpoint**: `v4/venues/{venueId}/locations/{locationId}/products/small/modified/{fromDate}/{fromMins}/{toDate}/{toMins}?addDayToEndOfRange={addDayToEndOfRange}`
- **Method**: `GET`
...
---
[🔗 View Original Documentation](https://api.tapin2.co/Help/Api/GET-v4-venues-venueId-locations-locationId-products-small-modified-fromDate-fromMins-toDate-toMins)
