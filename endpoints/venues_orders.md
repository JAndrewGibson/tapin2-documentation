# GET v2/venues/{venueId}/orders/{eventId}

Retrieve details for the specified endpoint.

- **Endpoint**: `v2/venues/{venueId}/orders/{eventId}`
- **Method**: `GET`
...
[
    {
        ...
        "seat": {
            ...
            "description": "Example Title",
            "isActive": true,
            "sectionRowTitle": "Sec 401-444, Row 1",
            "longTitle": "Sec 401-444",
            "id": 50001
        },
        "hasSeat": true,
        "pagerNumber": null,
        ...
        "totalNet": 0.0,
        "note": "",
        "guid": "bec42e66-2181-472e-903f-a52c30a46107",
        "saleDate": null,
        "printDate": null,
        "claimedDate": null,
    ...
    },
    {
        ...
        "totalNet": 0.0,
        "note": "",
        "guid": "e0aee251-4a88-4872-8503-99be0b597586",
        "saleDate": null,
        "printDate": null,
        "claimedDate": null,
        "lastInboundSmsDate": null,
...
---
[🔗 View Original Documentation](https://api.tapin2.co/Help/Api/GET-v2-venues-venueId-orders-eventId)
