# GET v2/venues/{venueId}/locations/{locationId}/events/{eventId}/alcoholcutoff

Retrieve details for the specified endpoint.

- **Endpoint**: `v2/venues/{venueId}/locations/{locationId}/events/{eventId}/alcoholcutoff`
- **Method**: `GET`
...
---
[🔗 View Original Documentation](https://api.tapin2.co/Help/Api/GET-v2-venues-venueId-locations-locationId-events-eventId-alcoholcutoff)
