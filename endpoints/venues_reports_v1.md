# GET v1/venues/{venueId}/reports/{reportType}/{fromDate}/{fromMins}/{toDate}/{toMins}

- **Endpoint**: `v1/venues/{venueId}/reports/{reportType}/{fromDate}/{fromMins}/{toDate}/{toMins}?addDayToEndOfRange={addDayToEndOfRange}`
- **Method**: `GET`
...
---
[🔗 View Original Documentation](https://api.tapin2.co/Help/Api/GET-v1-venues-venueId-reports-reportType-fromDate-fromMins-toDate-toMins)
